...
const ProfilePage = () => {
  ...
  const [formData, setFormData] = useState({
    address: '',
    phone: '',
    profileImage: '/images/mirz.jpg' // Initial profile image path
  });
  ...
  />
    ...
    <div className="text-center">
      <p><strong>Email:</strong> <span className="bg-gray-100 px-2 py-1 rounded">mirza@gmail.com</span></p>
      <p><strong>Position:</strong> <span className="bg-gray-100 px-2 py-1 rounded">Employee</span></p>
    </div>
  </div>
        </div>
        <div className="sm:w-4/6 p-3 flex items-center justify-center">
          ...
          <div className="bg-slate-50 p-6 rounded-lg flex-1 shadow-md hover:shadow-lg">
            <div className="space-y-4">
              <p><strong className="mr-2">Name:</strong> <span className=" px-2 py-1 rounded">Fathima Mirza</span></p>
              <p><strong className="mr-2">Email:</strong> <span className="px-2 py-1 rounded">mirza@gmail.com</span></p>
