...
const ManagerList = () => {
  ...
  useEffect(()=>{
    axios.get('http://localhost:8800/api/v1/auth/managers')
       .then(response => {
        ...
        <div className="bg-white rounded-lg w-1/2 mx-auto overflow-hidden">
          <div className="p-8">
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <div className="mt-4">
                <p className="text-gray-700 font-bold">Created Projects:</p>
                <ul className="list-disc pl-4">
          ...
          <div className="bg-gray-100 px-4 py-3 flex justify-end">
            <button className="text-white bg-blue-500 rounded px-4 py-2 mr-4" onClick={() => console.log('Update Role')}>Remove
            </button>
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold mb-8 mt-20 mb-20 text-center">
        <span style={{ textDecoration: "underline" }}>Managers Lists</span>
      </h2>
        ...
        {employees?.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
            {employees.map((employee) => (
              ...
              >
                <p className="text-gray-900 mb-2"><span className='font-bold'>Name:</span> {employee.name}</p>
