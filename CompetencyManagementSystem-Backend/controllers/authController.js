...
const managerList = async(req, res) => {
    ...
    //find user by id
    // console.log(req);
    const user = await User.findAll({where: {role: "manager"}});
    // console.log(user);
...
module.exports = {registerUser, loginUser, logoutUser,UserList,managerList};